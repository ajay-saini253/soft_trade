        ...
        <small className="iconbox_title">Career & Job</small>
         ...
         <li className="menu-item-has-children megamenu">
                ...
                {/* <li className="menu-item-has-children">
                    ...
                    <ul className="submenu">
                       <li><Link onClick={clickHandler} to="/blog"><span>Soft Trade Training </span></Link></li>
                      <li><Link onClick={clickHandler} to="/blog-single/AI-in-Neuroimaging-IXICOs-Cloud-Transformation"><span>Soft Trade </span></Link></li>
...
<div className="col-xl-10 col-md-4" onMouseEnter={() => setSelectedResources('training')}>
    <Link onClick={clickHandler} className="iconbox_block_2" to="/soft-trade-training">
      <span className="icon_title_wrap">
        <small className="iconbox_icon">
          <img src={icon2} alt="Soft Trade Training" />
        </small>
        <small className="iconbox_title">Soft Trade Training</small>
      </span>
