                ...
                <div className="row mt-none-30 g-0 align-items-start">
                    <div className="col-lg-8 mt-30">
                        <div className="blog_details_content">
                            ...
                            <p>Gain exclusive insights into the world of IT solutions with Soft Trade distinguished thought leaders. With years of experience and a deep understanding of industry trends, our thought leaders offer invaluable perspectives that illuminate the path to technological excellence. From emerging technologies to innovative strategies, they provide unique insights that inform and inspire. Join us as we delve into the inner workings of IT solutions, exploring the challenges.</p>
                            <p>Embark on an illuminating journey into the world of IT solutions with Soft Trade esteemed thought leaders. Delve deep into the inner workings of technology as our seasoned experts share their wealth of knowledge and experience. With a finger on the pulse of industry trends and a keen eye for innovation, our thought leaders offer unparalleled insights that illuminate the path</p>
                            ...
                            {/* <div className="other_post_nav ul_li_between">
                                <Link onClick={ClickHandler} to={'/blog'} className="post-nav-item">
                                    ...
                                    <div className="xb-item--holder">
                                        <h3 className="xb-item--title">Exploring IT solutions <br /> ..with Soft Trade</h3>
                            ...
                            {/* <div className="item_details-newslatter">
                                ...
                                <div className="xb-item--item-input_field pos-rel">
                                    <input type="email" placeholder="Soft Trade@example .com" />
