            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="input-field">
                        <label htmlFor="text1">Enter your Name</label>
                ...
                <div className="col-lg-12">
                    <div className="input-field">
                        <label htmlFor="text2">Enter your Email</label>
                        <div className="input-box">
                            <input
                                value={forms.email}
                                type="email"
                ...
                <div className="col-lg-12">
                    <div className="input-field">
                        <label htmlFor="text3">Enter your Phone</label>
                        <div className="input-box">
                            <input
                                value={forms.phone}
                                type="phone"
                ...
                <div className="col-lg-12">
                    <div className="input-field text-field">
                        <label htmlFor="text5">Enter your Message</label>
                        <div className="input-box">
                            <textarea
                                onBlur={(e) => changeHandler(e)}
                                onChange={(e) => changeHandler(e)}
