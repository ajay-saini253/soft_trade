...
import DataSolutioBlogSection from './DataSolutioBlogSection'
                            ...
                            {blogs.slice(0, 3).map((blog, Bitem) => (
                                <SwiperSlide key={Bitem}>
                                    <div className="blog-slide-item">
                                        <div className="xb-item--img"><Link onClick={ClickHandler} to={`/blog-single/${blog.slug}`}> <img src={blog.screens} alt="Blog Post" /></Link></div>
