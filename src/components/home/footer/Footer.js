        ...
        <div className="container">
            <div className="xb-footer">
                <div className="row">
                     <div className="col-lg-3 col-md-6">
                        <div className="footer-widget">
                         ...
                         <div className=" ul_li mb-4">
                            <div className="xb-item--icon information_icon">
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-widget">
                            ...
                            <ul className="xb-item--holder list-unstyled">
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/home-6">About Us</Link></li>
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/home-6">Contact</Link></li>
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/blog">Blog</Link></li>
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/home-6">Price</Link></li>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-widget">
                            ...
                            <ul className="xb-item--holder list-unstyled">
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/home-6">Mobile ERP Apps</Link></li>
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/home-6">Desktop ERP</Link></li>
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/blog">Web-Based ERP</Link></li>
                                <li className="xb-item--list"><Link onClick={ClickHandler} to="/home-6">Cloud Base ERP</Link></li>
                ...
                <div className="footer-copyright ul_li_between">
                    <p className="copyright mt-20">Copyright © 2025 <Link onClick={ClickHandler} to="/home-6">SOFTTRADE</Link>. All rights reserved.</p>
